_base_ = [
    '../_base_/models/depthformer_swin.py', '../_base_/datasets/kitti_mask.py',
...
data = dict(
    ...
    train=dict(
        ...
        ann_dir='depth_mde',
        depth_scale=256,
        split='/cluster/project/infk/courses/252-0579-00L/group26/nihars_tests/AdaBins/train_test_inputs/kitti_eigen_train_incl-gt_plus-renders_interpolate_post_sweep_plus-renders_angled_3_post_sweep.txt',
    ...
    val=dict(
        ...
        ann_dir='depth_mde',
        depth_scale=256,
        split='/cluster/project/infk/courses/252-0579-00L/group26/cfeldmann/Monocular-Depth-Estimation-Toolbox/splits/kitti_eigen_test.txt',
