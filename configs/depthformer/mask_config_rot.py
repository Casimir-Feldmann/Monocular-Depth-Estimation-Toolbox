...
data = dict(
    ...
    train=dict(
        ...
        ann_dir='depth_mde',
        depth_scale=256,
        split='/cluster/project/infk/courses/252-0579-00L/group26/nihars_tests/AdaBins/train_test_inputs/kitti_eigen_train_incl-gt_plus-renders_angled_3_post_sweep.txt',
