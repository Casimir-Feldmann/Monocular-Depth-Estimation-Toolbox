...
class KITTIDataset_Mask(Dataset):
            ...
            with open(split) as f:
                for line in f:
                    ...
                    if len(line.strip().split(" ")) == 4:
                        img_info['mask'] = line.strip().split(" ")[3]
    ...
    def get_mask_info(self, idx):
        ...
        return self.img_infos[idx].get('mask', None)
    ...
    def prepare_train_img(self, idx):
        ...
        mask_info = self.get_mask_info(idx)
        results = dict(img_info=img_info, ann_info=ann_info, mask_info=mask_info)
